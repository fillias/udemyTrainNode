...
/* pomoci mongoose vytvorime nove Schema 
** a do nej v {} urcime jak productSchema ma vypadat
*/
...
const productSchema = new Schema({
    ...
    userId: {
        /* reference na user id */
        type: Schema.Types.ObjectId,
        /* mongoose 'ref' - zde uvedeme ke kteremu Model se toto id vztahuje -  relation setup */
        ref: 'User', 
        required: true
    }
});
...
/* 
  ...
  vytvori collection se jmenem 'products' 
